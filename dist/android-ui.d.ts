...
declare module android.R.image_base64 {
    import NetImage = androidui.image.NetImage;
    var btn_check_off_disabled_focused_holo_light: NetImage;
    var btn_check_off_disabled_holo_light: NetImage;
    var btn_check_off_focused_holo_light: NetImage;
    var btn_check_off_holo_light: NetImage;
    var btn_check_off_pressed_holo_light: NetImage;
    var btn_check_on_disabled_focused_holo_light: NetImage;
    var btn_check_on_disabled_holo_light: NetImage;
    var btn_check_on_focused_holo_light: NetImage;
    var btn_check_on_holo_light: NetImage;
    var btn_check_on_pressed_holo_light: NetImage;
    var btn_radio_off_disabled_focused_holo_light: NetImage;
    var btn_radio_off_disabled_holo_light: NetImage;
    var btn_radio_off_focused_holo_light: NetImage;
    var btn_radio_off_holo_light: NetImage;
    var btn_radio_off_pressed_holo_light: NetImage;
    var btn_radio_on_disabled_focused_holo_light: NetImage;
    var btn_radio_on_disabled_holo_light: NetImage;
    ...
    var progressbar_indeterminate_holo4: NetImage;
    var progressbar_indeterminate_holo5: NetImage;
    var progressbar_indeterminate_holo6: NetImage;
    var progressbar_indeterminate_holo7: NetImage;
    var progressbar_indeterminate_holo8: NetImage;
    var rate_star_big_half_holo_light: NetImage;
    var rate_star_big_off_holo_light: NetImage;
    var rate_star_big_on_holo_light: NetImage;
    var scrubber_control_disabled_holo: NetImage;
    var scrubber_control_focused_holo: NetImage;
    var scrubber_control_normal_holo: NetImage;
    var scrubber_control_pressed_holo: NetImage;
    var spinner_76_inner_holo: NetImage;
    var spinner_76_outer_holo: NetImage;
}
declare module android.R {
